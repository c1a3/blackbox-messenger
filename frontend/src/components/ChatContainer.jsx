...
import SharedTasksPanel from "./SharedTasksPanel"; // Import Panel
import { useSharedTaskStore } from "../store/useSharedTaskStore"; // Import Store
...
const ChatContainer = () => {
  ...
  const { isPanelOpen } = useSharedTaskStore(); // Get panel state
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-base-200"> 
      ...
      <div className="flex-1 flex overflow-hidden">
                     ...
                     <div className="relative chat-bubble-container">
                         <div
                            className={`chat-bubble flex flex-col max-w-xs md:max-w-md ${
                                ...
                                ${message.isEphemeral ? 'border-2 border-orange-500' : ''}`}
          ...
          {/* RIGHT SIDE PANEL - SHARED TASKS */}
          {isPanelOpen && <SharedTasksPanel />}
      </div>
    </div>
  );
};
